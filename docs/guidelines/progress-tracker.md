...
| NXS-115 | Correção: Adicionar Error Boundary Global | ✅ Concluído | `spec/NXS-115-global-error-boundary` |
...
- **NXS-115**: Correção: Adicionar Error Boundary Global - 2026-06-21
